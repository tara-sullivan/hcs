...
\end{equation*}
Note that the beta distribution $\mathcal{B} \pr{\alpha_{j0}^g, \beta_{j0}^g}$ can also be specified as $\mathcal{B} \pr{\mu_{j0} n_{j0}^g, (1 - \mu_{j0}) n_{j0}^g}$.
